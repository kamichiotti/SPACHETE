...
start_time = time.time()
subprocess.call(["python","SPORK/denovo_pipeline.py",ALIGN_PARDIR,DATASET_NAME,MODE,NUM_FLANKING,NTRIM,DENOVOCIRC,OUTPUT_DIR])
...
#write_time("Alphabetize reg inds",start_time,timer_file_path)


#print("STATUS:sorting reg files")
...
## JS remove for spork
#start_time = time.time()
#print("STATUS:sorting genome files")
#processes = {}
#for index in range(1,NUM_FILES + 1):
...
#    processes[popen] = {"stdout":stdout,"stderr":stderr,"cmd":cmd}
#checkProcesses(processes)
#write_time("Alphabetize gen inds",start_time,timer_file_path)
#
#
...
#    processes[popen] = {"stdout":stdout,"stderr":stderr,"cmd":cmd}
#checkProcesses(processes)
#write_time("Paired end finder inds",start_time,timer_file_path)

#print("STATUS:Outputting Mismatched paired ends")
...
## JS remove for spork
#start_time = time.time()
#print("STATUS:counting mismatch rates")
#processes = {}
#for index in range(1,NUM_FILES + 1):
...
#    processes[popen] = {"stdout":stdout,"stderr":stderr,"cmd":cmd}
#checkProcesses(processes)
#write_time("DistantPE_counter inds",start_time,timer_file_path)
...
## JS remove for spork
#start_time = time.time()
#print("STATUS:sorting mismatched PE files")
#processes = {}
#for index in range(1,NUM_FILES + 1):
...
#    processes[popen] = {"stdout":stdout,"stderr":stderr,"cmd":cmd}
#checkProcesses(processes)
#write_time("SortPairedEnds ind "+str(index),start_time,timer_file_path)
...
#print("STATUS:make fusion fasta files")
#for i in range(1,25):
#    processes = {}
#    if i == 23:
#        i = "X"
...
#        processes[popen] = {"stdout":stdout,"stderr":stderr,"cmd":cmd}
#    checkProcesses(processes)
#    write_time("Making fusion ind chr "+str(i),start_time,timer_file_path)
