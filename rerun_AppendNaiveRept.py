...
print "In rerun_Append.py: FarJuncDir =",args.FarJuncDir
print "In rerun_Append.py: glmReportsDir =",args.glmReportsDir
print "In rerun_Append.py: stem =",args.stem
print "In rerun_Append.py: FJGLM =",args.FJGLM
print "In rerun_Append.py: OUT =",args.outputdir
