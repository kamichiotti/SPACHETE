...
getOverlapForTrimmed <- function(x, juncMidpoint=150){
    ...
    ## potential changes for SPORK: currently
      overlap = min(36,as.numeric(x["pos"]) + as.numeric(x["readLen"]) - juncMidpoint, juncMidpoint + 1 - as.numeric(x["pos"]))
## CONSIDER PENALTY PER ROB'S SUGGESTION
if (overlap>36){ overlap=36-overlap}
